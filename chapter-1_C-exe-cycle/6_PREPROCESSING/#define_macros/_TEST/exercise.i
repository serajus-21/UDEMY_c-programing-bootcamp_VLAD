...
int main(void)
{
    ...
    printf("\n\n_________________________"); printf("%d", (1)); printf("_________________________\n");
    ...
    printf("\n\n_________________________"); printf("%d", (2)); printf("_________________________\n");

    float radius = 0;
    printf("Enter Radius: "); scanf("%f", &radius);
    float area_of_circle = ((3.1416) * (radius) * (radius));
    float circumference_of_circle = ((2) * (3.1416) * (radius));
    printf("AREA = %f ||| CIRCUMFERENCE = %f\n", area_of_circle, circumference_of_circle);



    printf("\n\n_________________________"); printf("%d", (3)); printf("_________________________\n");
    ...
    printf("\n\n_________________________"); printf("%d", (4)); printf("_________________________\n");
    ...
    printf("\n\n_________________________"); printf("%d", (5)); printf("_________________________\n");

    int userInput = 0;
    printf("Enter number for square & qube: ");
    scanf("%d", &userInput);
    int square_of_input = ((userInput) * (userInput));
    int qube_of_input = ((userInput) * (userInput) * (userInput));
    printf("SQR = %d | QB = %d\n", square_of_input, qube_of_input);



    printf("\n\n_________________________"); printf("%d", (6)); printf("_________________________\n");

    int avNum1 = 0, avNum2 = 0, avNum3 = 0;
    printf("Enter three values of average: ");
    scanf("%d %d %d", &avNum1, &avNum2, &avNum3);
    float average = ((avNum1 + avNum2 + avNum3) / 3);
    printf("Average as floating: %.2f\n", average);



    printf("\n\n_________________________"); printf("%d", (7)); printf("_________________________\n");
    ...
    printf("\n\n_________________________"); printf("%d", (8)); printf("_________________________\n");

    int conX=34, conY=33;
    int forge = 1;

    if(forge) {
        do { conX = 0; conY = 0; } while (0);
        printf("RESET: %d %d\n", conX, conY);
    } else {
        printf("RESET: %d %d\n", conX, conY);
    }
    ...
    printf("\n\n_________________________"); printf("%d", (9)); printf("_________________________\n");
